    ...
    <main className="min-h-svh bg-background flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-2 mb-8 justify-center">
          ...
          <span className="text-lg font-semibold tracking-tight">Adstral</span>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1.5 leading-relaxed">
              {isSignUp
                ? "Start launching smarter campaigns in minutes."
                : "Sign in to your advertising command center."}
            </p>
          </div>
